...
<template>
  <section class="bbi-page">
    <!-- 标题行右端显示版本号(纯展示:更新检测已撤——本 fork 的更新源与上游不同,
         指回上游的比对会误报「有新版本」并诱导用户把上游覆盖进来,见 architecture.md) -->
    <div class="bbi-page-head">
      <h2 class="bbi-title bbi-title-sub">设置</h2>
      <div class="bbi-ver-row">
        <span class="bbi-ver">v{{ PLUGIN_VERSION }}</span>
      </div>
    </div>
    <hr class="bbi-rule" />
...
/* —— 版本标签:实心强调底 + 反白字,纯展示(更新检测已撤,不再可点) —— */
.bbi-ver {
  padding: 7px 12px;
